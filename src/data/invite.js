export const RSVP_STORAGE_KEY = 'wedding-rsvp-list'

export const invite = {
  bride: 'Thị Hân',
  groom: 'Văn Hào',
  groomFamilyTitle: 'Nhà trai',
  groomParents: ['Ông Phạm Văn Quán', 'Bà Hứa Thị Nga'],
  brideFamilyTitle: 'Nhà gái',
  brideParents: ['Ông Nguyễn Thanh Tâm', 'Bà Nguyễn Thị Hạnh'],
  date: '02/05/2026',
  dateFull: 'Thứ Bảy, ngày 2 tháng 5 năm 2026',
  dateCompact: '02 . 05 . 2026',
  lunarDate: '(Tức ngày 16 tháng 03 năm Bính Ngọ)',
  rsvpDeadline: '16/03/2025',
  time: '14:30',
  venue: 'Gia đình Nhà Trai',
  ceremonyVenueLabel: 'Tại tư gia Nhà Trai',
  address: 'Nhà văn hoá Thôn Vạn Hoà, xã Ân Hảo, Tỉnh Gia Lai',
  dressCode: 'Garden Chic - Pastel tones',
  hashtag: '#HaoHanForever',
  message:
